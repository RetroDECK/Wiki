...
We strongly recommend using in-game saves only, as we do for all systems and always backup first.
...
However, a firmware reinstallation will still be required. Make sure you perform in-game saves beforehand, always backup first.
...
- Exposed several previously hard-to-find texture pack folders for the following cores: Citra, Dolphin, PPSSPP, and Flycast. These are now available at `retrodeck/texture_packs/retroarch-core/<core>`. **Read more:** [RetroArch: Texture Packs](../../wiki_multi_emulator_guides/retroarch/retroarch-texture-pack.md).
