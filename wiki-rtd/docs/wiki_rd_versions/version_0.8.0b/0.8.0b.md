...
- Try to turn off the RetroDECK's Steam Input via Select RetroDECK in Steam -> Properties -> Controller -> Disable Steam Input. Then go to Steam -> Settings -> Controller -> Desktop Profile and Apply the RetroDECK profile under Templates.
