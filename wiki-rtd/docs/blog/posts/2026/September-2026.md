...
Wild Lee also have a connection with **Anbernic**. He assists with several of their social media platforms and also helps host guests visiting the company acting a bridge between East and West.
...
We are now starting to see what **RetroDECK 0.11.0** will become. 
...
We are not ready to reveal everything just yet. For now, the only thing we can share is:
