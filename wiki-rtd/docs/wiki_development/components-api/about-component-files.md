# RetroDECK Required Components Files

The packaged files with a RetroDECK component are the information center for that component. 
...
"setting_name1" - The name of the setting being changed. This would be the actual line name used in the component config file being edited for this preset.
...
Here is a WIP manifest.json file for RetroArch as a real-world example.
...
Here is an example of a specific prepare_component.sh file for the PPSSPP component:
...
Here is an example component_launcher.sh file for the PPSSPP component:
