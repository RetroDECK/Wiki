...
- In `es_find_rules.xml`, the `<emulator name="FLATPAKSPAWN">` has been added, making it easier for users who want to tinker with RetroDECK and break out of the sandbox (Heretics).
