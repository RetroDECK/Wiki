...
**Flips** (Floating IPS) is a lightweight, patcher that supports both `.ips` and `.bps` formats, allowing users to apply and create ROM ack patches.
...
<img src="../../../wiki_icons/pixelitos/portmaster-logo.png" width="75">
