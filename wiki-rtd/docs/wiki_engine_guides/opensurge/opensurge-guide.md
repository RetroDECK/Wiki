...
## Does Open Surge require BIOS, Game Data or Firmware files?
...
<img src="../opensurge-speedy.png" width="250" alt="Speedy Folder">
...
<img src="../Surge the Rabbit.png" width="800" alt="Opensurge Surge Miximage">

You can enable the built-in **Surge the Rabbit** game using the RetroDECK Configurator.

1. Open **RetroDECK Configurator**.
2. Navigate to **ES-DE Entries** → **Open Surge: Surge the Rabbit**.
...
You can disable the built-in **Surge the Rabbit** game using the RetroDECK Configurator.
