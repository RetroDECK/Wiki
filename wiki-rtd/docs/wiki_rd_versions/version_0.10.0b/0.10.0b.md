...
- Exposed previously hard-to-find texture pack folders for the following cores: Citra, Dolphin, PPSSPP, and Flycast.  These are now available at `retrodeck/texture_packs/retroarch/<core>`. **Read more:** [RetroArch: Texture Packs](../../wiki_emulator_guides/retroarch/retroarch-texture-pack.md)
