...
**Note:** This does not remove any roms, saves, bios or configurations you had if you are upgrading from an older version. It only removes the ability to run the games via those emulators as they are no longer included.
