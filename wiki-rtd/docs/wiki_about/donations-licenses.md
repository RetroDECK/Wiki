...
| Component | Logo | Description | Donate / Support | Licenses |
|----------|-------|-------------|------------------|----------|
| **LibreRetro – RetroArch** | <img src="../../wiki_images/logos/retroarch-logo.png" width="75"> | The LibreRetro Team makes RetroArch, Libretro, and Lakka. | - [Teespring](https://teespring.com/stores/retroarch) <br> - [Patreon](https://www.patreon.com/libretro) <br> - [YouTube Membership](https://www.youtube.com/channel/UCjAimkVp-G_o6HK5MXujk9A/join) <br> - [Liberapay](https://liberapay.com/Libretro/donate) - [BountySource](https://salt.bountysource.com/checkout/amount?team=libretro) | - [Licenses](https://docs.libretro.com/development/licenses/) |
...
| **ares** | <img src="../../wiki_images/logos/ares-logo.png" width="180"> | A cross-platform, open-source, multi-system emulator focused on accuracy and preservation. *(Not yet added to RetroDECK)* |  [Patreon](https://www.patreon.com/LukeUsher) | [Licenses](https://github.com/ares-emulator/ares/blob/master/LICENSE) |
...
| Component | Logo | Description | Donate / Support | Licenses |
|----------|-------|-------------|------------------|----------|
| **RPCS3** | <img src="../../wiki_images/logos/rpcs3-logo.png" width="75"> | Free and open-source PlayStation 3 emulator/debugger for Windows, Linux, macOS, and FreeBSD. | - [Patreon](https://patreon.com/Nekotekina) <br> - [Alipay](https://rpcs3.net/alipay) | — |
...
| **melonDS** | <img src="../../wiki_images/logos/melonds-logo.svg" width="75"> | Fast and accurate Nintendo DS emulator with an expanding feature set. | - [Patreon](https://www.patreon.com/Arisotura) <br> - [PayPal](https://paypal.me/Arisotura) | - [Licenses](https://github.com/melonDS-emu/melonDS/blob/master/LICENSE) |
...
| **DOSBox-X** | <img src="../../wiki_images/logos/dosbox-x-logo.svg" width="75"> | Open-source DOS emulator for running DOS games and applications. | No donation link available or donations not supported. | - [Licenses](https://github.com/joncampbell123/dosbox-x?tab=GPL-2.0-1-ov-file#readme) |
...
| **IKEMEN Go** | <img src="../../wiki_images/logos/ikemen-go-logo.png" width="75"> | Remake of the IKEMEN fighting game engine (compatible with M.U.G.E.N resources) written in_
...
| **Kenney.nl** | RetroDECK Team owns a separate donation license. | - [Kenney.nl](https://www.kenney.nl/) <br> - [Patreon](https://www.patreon.com/kenney) <br> - [itch.io](https://kenney.itch.io/kenney-donation) | CC0 & CC1 |
...
## Proprietary / Closed Source Emulators

These emulators cannot be added to RetroDECK, but we want to recognize their work.
