...
These are still **work-in-progress** and subject to frequent major changes.
...
| [Step 4 Add Component to ES-DE](https://retrodeck.readthedocs.io/en/latest/wiki_development/components/es-de-add-component/) | Final step: integrating the component into the ES-DE frontend               |
