...
**RetroLACE** allows you to manually install unsupported external components that are not included with the official RetroDECK or RetroVERSE distribution.
...
RetroLACE components should be extracted into the `retrodeck/storage/retrodeck/retrolace/` directory and correctly written components in this directory are automatically loaded during the next RetroDECK boot.
...
- You understand that enabling RetroLACE and installing **unsupported components** will cause your RetroDECK installation to be considered **Modified** and may affect your ability to receive RetroDECK support for issues related to, or potentially caused by, the modified installation.
