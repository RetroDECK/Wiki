...
| **Lahrs Folder Icons**                     | Lahrs contributed a large set of folder icons for RetroDECK. Some Icons based on the work of Dan Patrick, that Lahrs got the permission to use.                                       | -                                                                                                         | RetroDECK Team                                           |
