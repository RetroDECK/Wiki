...
Downloading media files still depends on your internet speed and SRM parsers, which we can't change. However, we've improved the functions in RetroDECK that feed the favorites information to the parsers.
