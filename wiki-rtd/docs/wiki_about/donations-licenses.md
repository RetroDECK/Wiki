...
| **Eden**       | <img src="../../wiki_images/logos/eden-logo.svg" width="75">                                      | Open-source Nintendo Switch emulator.                                                                                 | [Website](https://eden-emu.dev/donations)                                         |  [Licenses](https://git.eden-emu.dev/eden-emu/eden/src/branch/master/LICENSES) |
...
| Component | Logo | Description | Donate / Support | Licenses |
|----------|-------|-------------|------------------|----------|
| **Mudlet** | <img src="../../wiki_images/logos/mudlet-logo.png" width="75"> | MUD client for playing text-based online games. | No donation link available or donations not supported. |  [Licenses](https://github.com/Mudlet/Mudlet?tab=GPL-2.0-1-ov-file#readme) |
