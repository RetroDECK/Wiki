...
<img src="../../../wiki_images/logos/lutris-logo.png" width="75" alt="Lutris logo">
...
**Note:** RetroDECK was never intended to be used in this manner, so things like inputs may not work as expected.
