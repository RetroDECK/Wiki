...
A new `retrodeck/videos` directory was added to store video recordings generated by supported components. This prevents video files from being mixed with screenshots in `retrodeck/screenshots`  (it was kinda stupid).
