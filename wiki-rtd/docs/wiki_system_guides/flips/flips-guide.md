...
1. Select **Create Patch** in the Flips window.
2. Select the original, unmodified ROM.
3. Select the modified ROM that contains your changes.
4. Choose a filename for the patch Flips will generate (.bps or .ips).
5. The patch file is created and ready to use.
