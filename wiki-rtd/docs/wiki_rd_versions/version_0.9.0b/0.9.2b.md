...
**ES-DE** just shipped a major update 3.2.0. Read the full changelog here: [ES-DE Frontend - Changelog](https://gitlab.com/es-de/emulationstation-de/-/blob/master/CHANGELOG.md)
